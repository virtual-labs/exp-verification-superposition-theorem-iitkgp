...
function perform4(){
		if(c1==1 && c2==1 && c3==1)
		{
			count=count+1;
			c1=0; c2=0; c3=0;
			dr1=i1.toPrecision(5); dr2=i2.toPrecision(5); dr3=i3.toPrecision(5); dr4=i11.toPrecision(5); dr5=i12.toPrecision(5); dr6=i13.toPrecision(5); dr7=i21.toPrecision(5); dr8=i22.toPrecision(5); dr9=i23.toPrecision(5); 
			document.f1.A1.value = 0; document.f1.A31.value = 0; document.f1.A21.value = 0; document.f1.A11.value = 0;
			document.f1.A2.value = 0; document.f1.A32.value = 0; document.f1.A22.value = 0; document.f1.A12.value = 0;
			document.f1.A3.value = 0; document.f1.A33.value = 0; document.f1.A23.value = 0; document.f1.A13.value = 0;
			perform_meter1();
			perform_meter2();
			perform_meter3();
